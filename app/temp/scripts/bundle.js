...
var RevealOnScroll = function () {
  ...
  _createClass(RevealOnScroll, [{
    ...
    value: function createWayPoints() {
      var that = this; // We want the this keyword to point to the constructor itself when we use it with offset. We store the value in this level in variable so we use the varaible blow instead the keword itself. The keyword itself points to the inner object.
...
var StickyHeader = function () {
  ...
  _createClass(StickyHeader, [{
    ...
    value: function createHeaderWaypoint() {
      var that = this; // The pointing dest of this is stored for later.
      new Waypoint({
    ...
    value: function createPageSectionWaypoint() {
      var that = this; // Get the this dest (main object) for removing the class bellow
      this.pageSections.each(function () {
        var currentPageSection = this; // The dest this is pointing
        new Waypoint({
          ...
          handler: function handler(direction) {
            if (direction == "down") {
              ...
              (0, _jquery2.default)(matchingHeaderLink).addClass('is-current-link'); // Add the the modifier class to the link we are in.
            }
          },
          offset: "18%"
        });
...
var Modal = function () {
  ...
  _createClass(Modal, [{
    ...
    value: function openModal() {
      ...
      // This is to avoid the links default behaviour that jumps to the top upon clicking
      return false;
    }
  }, {
    key: 'closeModal',
